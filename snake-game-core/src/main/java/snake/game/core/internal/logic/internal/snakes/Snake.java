...
class Snake {
    ...
    snake.game.core.dto.Snake toDto() {
        return new snake.game.core.dto.Snake(playerNumber, currentDirection, isAlive(), nodesDto());
    }

    private List<snake.game.core.dto.Snake.Node> nodesDto() {
        return nodes
                .stream()
                .map(Node::toDto)
                .collect(toList());
    ...
    private static class Node {
        ...
        snake.game.core.dto.Snake.Node toDto() {
            return new snake.game.core.dto.Snake.Node(position, hasFood);
        }
