...
@Slf4j
class StartGameMapper {

    public Option<Tuple4<String, GameSpeed, GridSize, Walls>> map(AtmosphereResource r, String msg) {
        try {
            return Option.of(Tuple.of(r.uuid(), gameSpeed(msg), gridSize(msg), walls(msg)));
        } catch (Exception e) {
