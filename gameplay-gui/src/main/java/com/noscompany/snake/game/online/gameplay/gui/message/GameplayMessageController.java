package com.noscompany.snake.game.online.gameplay.gui.message;
...
public class GameplayMessageController extends AbstractController {
    @FXML
    ...
    public Subscription getSubscription() {
        return new Subscription()
                .toMessage(PlayerTookASeat.class, this::playerTookSeat)
                ...
                .subscriberName("gameplay-message-gui");
    }

    private void playerTookSeat(PlayerTookASeat event) {
