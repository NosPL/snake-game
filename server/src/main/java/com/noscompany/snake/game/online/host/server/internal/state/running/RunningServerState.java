...
import static com.noscompany.snake.game.online.host.server.RoomEventHandlerForRemoteClients.SendMessageError.FAILED_TO_SENT_MESSAGE;
...
class RunningServerState implements ServerState {
    ...
    @Override
    public Try<ServerState> start(ServerParams serverParams, RoomApiForRemoteClients roomMediatorForRemoteClients) {
    ...
    private Optional<AtmosphereResource> findResourceById(RoomApiForRemoteClients.RemoteClientId remoteClientId) {
